...
浏览器内使用的下跌 / 上涨金字塔资金与目标价试算，可在界面选择 **3 / 4 / 5 档**（资金按 10 份比例：3 档 1:3:6，4 档 1:2:3:4，5 档 1:2:2:2:3；上涨侧为下跌份数倒序）。逻辑与 [`calculate_pyramid.py`](calculate_pyramid.py) 中 `num_tiers` 参数一致。
